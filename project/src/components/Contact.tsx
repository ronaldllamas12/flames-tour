      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="oceania">Australia & Pacifico</option>
                  </select>
                </div>
              </div>
          ...
          <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p>Conjunto Iguazu</p>
                    <p>Cartagenade Indias, Colombia</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p>Booking Support: +1 (555) 987-6543</p>
                  </div>
                </div>
            ...
            <div className="bg-gray-50 p-6 md:p-8 rounded-lg shadow-md">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Horario Laboral</h3>
              ...
              <div className="mt-4 pt-4 border-t border-gray-200">
                <p className="text-gray-600">
                  24/7 Soporte de Asistencia de Viajes 
                </p>
              </div>
            </div>
          </div>
